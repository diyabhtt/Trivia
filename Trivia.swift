...
//  Trivia
//
//  Created by Bhattarai, Diya on 2/8/24.
//
...
struct Trivia
{
    ...
    init(q: String = "", correct: String = "", incorrect: [String]) {
        self.questions = q
        self.correctA = correct
        self.incorrectA = incorrect
        
    }
    
    static func getQuestions(_ key : String) -> [Trivia]?
    {
        return dictionary[key]
    }
    
    static func getCatergories() -> [String]
    {
        var s : [String] = []
